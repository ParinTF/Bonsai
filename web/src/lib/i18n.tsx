...
const dict = {
  en: {
    ...
    'landing.headline': 'Grow big goals from small daily habits',
    'landing.subtext': 'Break a big goal into sub-goals and daily habits — progress rolls up automatically as you check things off, no spreadsheets required.',
    'landing.tryDemo': 'Try Demo',
    'landing.signUp': 'Sign Up',
    'landing.logIn': 'Log In',
    'landing.featuresTitle': 'Everything you need to actually stick with it',
    'landing.feature.hierarchy.title': 'Hierarchical goals',
    'landing.feature.hierarchy.desc': 'Big goal → sub-goals → daily habits, all on one draggable canvas instead of a flat list.',
    'landing.feature.types.title': '7 progress types, auto rollup',
    'landing.feature.types.desc': 'Stages, numeric targets, checklists, habits, and commitments — a parent’s progress is computed from its children, never guessed.',
    'landing.feature.ai.title': 'AI goal breakdown',
    ...
    'editor.markSuccess': 'Mark as success',
    'editor.success': 'Success',
    'editor.undoSuccess': 'Undo',
    'editor.successHint': 'Shows 100% even while sub-goals below are still in progress.',
  ...
  th: {
    ...
    'landing.headline': 'ปลูกเป้าหมายใหญ่จากนิสัยเล็กๆ ในแต่ละวัน',
    'landing.subtext': 'แตกเป้าใหญ่เป็นเป้าย่อยและ habit รายวัน — ความคืบหน้ารวมขึ้นให้อัตโนมัติทุกครั้งที่ติ๊กสำเร็จ ไม่ต้องทำสเปรดชีตเอง',
    'landing.tryDemo': 'ลองเดโม',
    'landing.signUp': 'สมัครสมาชิก',
    'landing.logIn': 'เข้าสู่ระบบ',
    'landing.featuresTitle': 'ครบทุกอย่างที่ช่วยให้ทำต่อเนื่องได้จริง',
    'landing.feature.hierarchy.title': 'เป้าหมายแบบลำดับชั้น',
    'landing.feature.hierarchy.desc': 'เป้าใหญ่ → เป้าย่อย → habit รายวัน ทั้งหมดอยู่บน canvas ที่ลากจัดเองได้ ไม่ใช่ลิสต์แบนๆ',
    'landing.feature.types.title': '7 ชนิดการวัดผล รวมยอดอัตโนมัติ',
    'landing.feature.types.desc': 'stages, ตัวเลข, checklist, habit และข้อผูกมัดรายสัปดาห์ — % ของเป้าใหญ่คำนวณจากลูกเสมอ ไม่ใช่การเดา',
    'landing.feature.ai.title': 'AI แตกเป้าหมายให้อัตโนมัติ',
    ...
    'editor.markSuccess': 'ทำสำเร็จแล้ว',
    'editor.success': 'สำเร็จ',
    'editor.undoSuccess': 'ยกเลิก',
    'editor.successHint': 'จะแสดง 100% แม้เป้าย่อยด้านล่างยังทำไม่เสร็จ',
