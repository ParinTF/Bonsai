...
112 xUnit tests — pure-logic tests plus 4 `[SkippableFact]` integration tests that boot the real app against Mongo (and skip, not fail, when none is reachable):
